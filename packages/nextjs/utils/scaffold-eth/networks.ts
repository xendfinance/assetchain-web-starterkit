...
export const RPC_CHAIN_NAMES: Record<number, string> = {
  ...
  [chains.assetChainTestnet.id]: "assetchain-testnet",
...
export const getAlchemyHttpUrl = (chainId: number) => {
  // Check if the chainId corresponds to "assetchain-testnet"
  if (RPC_CHAIN_NAMES[chainId] === "assetchain-testnet") {
    return "https://enugu-rpc.assetchain.org";
  }

  // Check if the chainId exists in RPC_CHAIN_NAMES and return the Alchemy URL
